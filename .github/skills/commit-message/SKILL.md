---
name: commit-message
description: Use this skill when the user asks to generate a commit message for the current work. Generate it strictly from the staged git diff (index) only, and include a staged-files debug section.
---
